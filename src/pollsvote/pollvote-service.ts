...
import { pollsVoteRepository } from './pollvote-repository';

class PollsVoteService {
    ...
    async cancelVote(optionId: string, userId: string) {
...
export const pollsVoteService = new PollsVoteService();

...
export const CreatePolls: ExpressHandler = async (req: ExpressRequest, res: ExpressResponse) => {
...
export const GetAllPollList: ExpressHandler = async (req: ExpressRequest, res: ExpressResponse) => {
...
export const GetPollInformation: ExpressHandler = async (req: ExpressRequest, res: ExpressResponse) => {
...
export const UpdatePoll: ExpressHandler = async (req: ExpressRequest, res: ExpressResponse) => {
...
export const DeletePoll: ExpressHandler = async (req: ExpressRequest, res: ExpressResponse) => {

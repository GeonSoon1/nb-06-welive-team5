...
<table>
  ...
  <tr>
    <td align="center"><sub>인증, 사용자, 아파트 관리 <br /> / 인프라 구축</sub></td>
    <td align="center"><sub>투표, 공지사항, 알림, 이벤트 관리 <br /> / 프론트 연동</sub></td>
    <td align="center"><sub>입주민, 민원, 댓글 관리 <br /> / 배포 자동화</sub></td>
  </tr>
</table>
